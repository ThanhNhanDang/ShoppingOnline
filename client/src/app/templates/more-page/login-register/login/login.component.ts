import { urlVerify } from './../../../../../environments/environment';
...
export class LoginComponent implements OnInit {
  ...
  loginForm!: FormGroup;
  error!: string;
  constructor(private authService: SocialAuthService, private http: HttpServiceService, private router: Router, private appCookie: AppCookieService, public _location: Location) {
  }
