...
export class MyAccountComponent implements OnInit {
  ...
  updateMyAccount(){
    if(this.file!=null)
      this.userPayload.image_url="images/avatars/"+this.userPayload.id+"/"+this.fileName
  ...
  updateAvatar(){
    if(this.file != null){
      this.http.pushFileToStorage("/user/update/image?id="+this.userPayload.id, this.file).subscribe(()=>{
